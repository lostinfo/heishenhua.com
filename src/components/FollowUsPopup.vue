<template>
  <div v-show="visible" class="gs-follow-us-popup">
    <div class="grey-bg" @click="$emit('update:visible', false)"></div>
    <div class="gs-follow-us-popup-container">
      <div class="follow-us-popup-box">
        ...
        <div class="box-content">
          <div v-if="followSuccess" class="box-success">
            <div>预约成功！</div>
            <div>感谢您的关注!</div>
          </div>
          <div v-if="!followSuccess" class="box-form">
            <input
      ...
      <div class="follow-us-close-btn" @click="$emit('update:visible', false)">
...
export default {
  ...
  methods: {
    ...
    setToken: function() {
      this.formData.token = webc.genEncryptToken(this.formData.phone + this.formData.mail);
    },
