<template>
  <div class="gs-home-nav">
    <transition name="nav">
      <div v-if="navType==1" class="top-bar">
        <div
    ...
    <transition name="nav">
      <div v-if="navType==2" class="left-bar">
        <div
          v-for="(item, i) in data"
          :key="i"
          class="left-bar-item"
        ...
        >
          <div class="select-point">
            ...
            <img v-if="item.id==navActive" class="select-point-active" src="/img/b1/nav_ck.png" />
            <img v-else class="select-img" src="/img/b1/nav_hover.png" />
          </div>
