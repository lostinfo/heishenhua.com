<template>
  <div class="gs-image-popup" v-show="visible">
    <div class="bg-cover" @click="closeFullScreen"></div>
    <img :style="imgStyle" ref="popupImg" class="popup-img" />
    <img src="/img/news/btn_esc.png" class="close-btn" @click="closeFullScreen" />
  </div>
</template>
