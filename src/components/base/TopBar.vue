<template>
  <div class="gs-topbar">
    <div class="gs-topbar-logo">
      <div class="gamesci-logo" @click="urlRedirect('http://www.gamesci.com.cn')">
        <img src="/img/b1/img_logo_gs.png" />
      </div>
      <div class="b1-logo" @click="goToHome">
        <img src="/img/b1/img_logo_bm.png" />
      </div>
    </div>
    <div v-if="!isPhone" class="gs-topbar-follow">
      <div class="follow-text">
        关注<br>我们
      </div>
      <div class="follow-item follow-bilibili can-click"
           @click="urlRedirect(bilibiliInfo.url)"
      >
        <img class="follow-logo" src="/img/b1/btn_contact_bilibili.png" />
        <FollowHover class="follow-hover-box" :data="bilibiliInfo" />
      </div>
      <div class="follow-item follow-sinablog can-click"
           @click="urlRedirect(sinablogInfo.url)"
      >
        <img class="follow-logo" src="/img/b1/btn_contact_sinablog.png" />
        <FollowHover class="follow-hover-box" :data="sinablogInfo" />
      </div>
      <div class="follow-item follow-wechat"
           @click="urlRedirect(wechatInfo.url)"
      >
        <img class="follow-logo" src="/img/b1/btn_contact_wechat.png" />
        <FollowHover class="follow-hover-box" :data="wechatInfo" />
      </div>
    </div>
